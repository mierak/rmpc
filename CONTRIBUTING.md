...
* You will also need to have rust installed on your system. You can install it from the [official website](https://www.rust-lang.org/tools/install) or via your package manager. I recommend using `rustup` to manage your rust installation as it allows you to easily switch between different versions of rust and install additional tools like `rustfmt` and `clippy`.
...
Please fill the [Bug Report](https://github.com/mierak/rmpc/issues/new?template=bug.yml) template if you encounter an issue which is not yet solved in the current git version of rmpc and include all information relevant to your issue.
...
Similar to the bug report, please fill out the [Feature Request](https://github.com/mierak/rmpc/issues/new?template=feature.yml) template.
...
The docs area created with [astro](https://astro.build/) javascript framework. All contributions and improvements to the documentation are welcome.
