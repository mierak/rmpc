...
impl MpdClient for TestMpdClient {
    ...
    fn play_pos(&mut self, pos: usize) -> MpdResult<()> {
        if (pos) < self.queue.len() {
            ...
            self.status.state = crate::commands::State::Play;
            Ok(())
        } else {
    ...
    fn stop(&mut self) -> MpdResult<()> {
        self.status.state = crate::commands::State::Stop;
        Ok(())
    }
    ...
    fn list_mounts(&mut self) -> MpdResult<crate::commands::Mounts> {
        todo!("Not yet implemented")
    }
    ...
    fn outputs(&mut self) -> MpdResult<crate::commands::outputs::Outputs> {
        todo!("Not yet implemented")
    }
    ...
    fn decoders(&mut self) -> MpdResult<crate::commands::decoders::Decoders> {
        todo!("Not yet implemented")
    }
    ...
    fn list_stickers(&mut self, _uri: &str) -> MpdResult<crate::commands::stickers::Stickers> {
        todo!("Not yet implemented")
    }
    ...
    fn list_stickers_multiple(
        &mut self,
        _uris: &[&str],
    ) -> MpdResult<Vec<crate::commands::stickers::Stickers>> {
        todo!("Not yet implemented")
    }
