...
Commands:
  ...
  toggle-output   Toggle MPD output on or off
  enable-output   Enable MPD output
  disable-output  Disable MPD output
  help            Print this message or the help of the given subcommand(s)

Options:
  -c, --config <FILE>      [default: /home/mrk/.config/rmpc/config.debug.ron]
