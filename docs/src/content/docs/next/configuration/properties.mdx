...
- `Transform` - Applies a tranformation on the properties in question like truncating the value to
...
Modifiers are also the same and possible values are `bold`, `dim`, `italic`, `underlined`, `reversed`
and `crossedout`. Multiple modifiers can be combined by separating them with a comma.
...
| `'Hello rmpc'{fg: black, bg: #FF0000, mods: bold, underlined}`<br/> black, bold and underlined "Hello rmpc" on red background                                                                                        |
...
| Property      | Descripiton                                         | Ron             | Template                   | Parameters |
| ------------- | --------------------------------------------------- | --------------- | -------------------------- | ---------- |
...
| Partition          | currently active partititon                                   | `Partition`               | `$f` or `$file`            |            |
...
| Property   | Descripiton                                                       | Ron           | Template                 |
| ---------- | ----------------------------------------------------------------- | ------------- | ------------------------ |
...
| Transform | Descripiton                                          | Ron             | Template                |
| --------- | ---------------------------------------------------- | --------------- | ----------------------- |
