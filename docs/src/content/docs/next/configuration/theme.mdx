...
<ConfigValue name="layout" type="other" customText="layout: Pane | Split" />
...
Configures how playback states are displayed in the header.

<ConfigValue name="playback_states" type="other" customText="PlaybackStates" />

#### playback_states.play_label

<ConfigValue name="play_label" type="string" />

Content of the `Playing` state in the header

#### playback_states.paused_label

<ConfigValue name="paused_label" type="string" />

Content of the `Paused` state in the header

#### playback_states.stopped_label

<ConfigValue name="stopped_label" type="string" />

Content of the `Stopped` state in the header
