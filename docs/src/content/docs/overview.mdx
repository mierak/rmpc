...
Some basic featuer are also available on the command line. Use `rmpc --help` to get a list of available commands or
check out the [CLI reference](/rmpc/reference/cli-command-mode)
