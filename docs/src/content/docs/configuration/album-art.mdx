...
| Kitty     | Kitty               | yes     | -                                                                                    |
| WezTerm   | ITerm2              | yes     | -                                                                                    |
| vscode    | ITerm2              | yes     | Needs to set album_art_max_size_px. Needs to be enabled in vscode.                   |
| Tabby     | ITerm2              | yes     | Needs to set album_art_max_size_px                                                   |
| Alacritty | Ueberzug            | yes     | Needs [ueberzugpp](https://github.com/jstkdng/ueberzugpp)                            |
| Others    | Ueberzug/Kitty/None | unknown | Untested/unsupported. Might need [ueberzugpp](https://github.com/jstkdng/ueberzugpp) |

## Configuration

### method

<ConfigValue name="method" type={["Kitty", "UeberzugWayland", "UeberzugX11", "None", "Auto"]} />
