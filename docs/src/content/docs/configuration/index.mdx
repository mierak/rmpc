...
<ConfigValue name="address" type="string" customText="<ip>:<port>" />

The address to connect to. By default rmpc tries to connect to MPD at `127.0.0.1:6600`. Socket connections are currently
not supported.
