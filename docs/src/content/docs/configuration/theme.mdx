...
Symblos to use in the various browser screens (artist, search, ...)
...
This symbol is used for selected items in the browser screens.
...
<ConfigValue name="track_style" type="string" customText="[elapsed, thumb, track]" />

Array of three single character strings that determine the look of the progress bar. First value is the elapsed part of
the progress bar, second is the thumb and the third is the empty track. Default is `["-", ">", " "]
...
<ConfigValue name="enabled" type="boolean" />
...
<ConfigValue
    ...
    link="/rmpc/configuration/song-table/"
/>
...
<LinkCard
    ...
    href="/rmpc/configuration/song-table/"
/>
...
<ConfigValue
    ...
    type="other"
    customText="<song_table_format>"
    link="/rmpc/configuration/song-table#song_property"
/>

Format used to display song in the various browser screens (albums, artists, ...). Is the same format as
[song_table_format](/rmpc/configuration/theme#song_table_format) except the styles are ignored.

Defaults to `Track Artist - Title`

### header

<ConfigValue name="header" type="other" customText="<header[]>" link="/rmpc/configuration/header/" />
...
<LinkCard title="header" description="Configuration of the window header" href="/rmpc/configuration/header/" />
